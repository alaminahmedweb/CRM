...
namespace Infrastructure.Data.Queries
{
    ...
    var buildingDetails = from bld in _dbContext.BuildingDetails.Where(a => a.CustomerId == bookingDto.CustomerId)
        ...
        public List<BookingItemDto> GetPendingBookingAmountChangeList(DateTime dateFrom, DateTime dateTo)
        {
        ...
        public bool IsPendingBookedAlready(int teamId, int shiftId, DateTime bookingDate)
        {
            return _dbContext.Bookings.Any(a => a.PendingTeamId == teamId && a.PendingShiftId == shiftId && a.PendingShiftDate == bookingDate && a.Status == "Shift-Pending");
        }
    }
